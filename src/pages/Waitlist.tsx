            ...
            {!submitted ? (
              ...
              >
                ...
                >
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-muted border border-primary/20 p-3 font-mono text-sm text-foreground focus:border-primary outline-none"
                      />
                    </div>
                    ...
                    <label className="flex items-start gap-3 cursor-pointer mt-4">
                      <input
                        type="checkbox"
                        required
                        checked={form.agreeKYC}
                        onChange={(e) => setForm({ ...form, agreeKYC: e.target.checked })}
                        className="mt-1 accent-primary"
                      />
                      <span className="font-body text-xs text-muted-foreground">
                        I agree to complete KYC before trading access is granted
                      </span>
                    </label>
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full btn-shimmer font-mono text-xs tracking-widest text-primary-foreground px-8 py-4 mt-6 font-medium"
                  >
                    SECURE MY SPOT →
                  </button>

                  <p className="mt-3 font-mono text-[10px] text-muted-foreground text-center">
                    No payment required. Demo trading only.
                  </p>
                </motion.form>
              </motion.div>
            ) : (
              ...
              >
                ...
                <p className="font-body text-muted-foreground mb-8">
                  Check your email for next steps. KYC instructions are on their way.
                </p>
                <p className="font-body text-sm text-muted-foreground mb-4">Know a serious trader? Send them here.</p>
                <div className="flex gap-3 justify-center mb-8">
                  <a href="#" className="gold-border px-4 py-2 font-mono text-[10px] tracking-widest text-foreground hover:bg-primary/5">
                    SHARE ON X
                  </a>
                  <a href="#" className="gold-border px-4 py-2 font-mono text-[10px] tracking-widest text-foreground hover:bg-primary/5">
                    WHATSAPP
